...
for (const text of ["Translations", "Übersetzungen", "runicEditorSave", "runicEditorSaveReview", "runicEditorAbout", "runicEditorCreateDiagnosticBundle", "runicEditorPreviewMessage", "Translate the message", "Interactive structure", "Compiler-backed preview", "Quality report", "About &amp; diagnostics", "Terminology", "schema v"]) {
