...
for (const text of ["Translations", "Übersetzungen", "runicEditorSave", "runicEditorSaveReview", "runicEditorPreviewMessage", "Structured message composer", "Compiler-backed preview", "Quality report", "Terminology", "schema v"]) {
