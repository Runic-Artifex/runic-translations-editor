...
for (const text of ["Translations", "Übersetzungen", "runicEditorSave", "runicEditorSaveReview", "runicEditorAbout", "runicEditorCreateDiagnosticBundle", "runicEditorPreviewMessage", "Structured message composer", "Compiler-backed preview", "Quality report", "About &amp; diagnostics", "Terminology", "schema v"]) {
