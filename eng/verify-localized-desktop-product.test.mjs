...
const journey = () => ({ schema: "runic.localized-desktop-product/1", isolation: { nuget: ".nuget/packages", npm: ".npm-cache" }, compatibility: { id: "runic-1.0-preview.1", releaseTrainVersion: "1.0.0-preview.1", sha256: "a".repeat(64) }, generated: { catalog: "editor", esmAbiVersion: 2, contractFingerprint: "sha256:" + "a".repeat(64) }, embedded: { sha256: "a".repeat(64) }, negativeGates: ["missing-manifest", "stale-manifest", "forged-manifest-schema", "unsupported-locale", "fingerprint-skew"], localeEvidence: ["en", "de", "structured-interchange"], nugetCandidates: Array.from({ length: 4 }, () => ({ source: "exact-local", archiveSha256: "a".repeat(64) })), npmCandidate: { identity: "@runic-artifex/vite-plugin-runic-translations", source: "exact-local", archiveSha256: "a".repeat(64) }, phases: ["tool-restore", "editor-build", "frontend-check", "manifest-contract", "editor-interchange-smoke", "editor-package", "package-smoke"].map(name => ({ name, status: "passed", exitCode: 0 })) });
